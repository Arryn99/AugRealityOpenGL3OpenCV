...
ScreenTextureShader::ScreenTextureShader()
{
}


ScreenTextureShader::ScreenTextureShader(const ScreenTextureShader& other)
{
}
...
bool ScreenTextureShader::Initialize(OpenGLClass* OpenGL, HWND hwnd)
{
	bool result;
...
void ScreenTextureShader::Shutdown(OpenGLClass* OpenGL)
{
...
void ScreenTextureShader::SetShader(OpenGLClass* OpenGL)
{
...
bool ScreenTextureShader::InitializeShader(char* vsFilename, char* fsFilename, OpenGLClass* OpenGL, HWND hwnd)
{
...
char* ScreenTextureShader::LoadShaderSourceFile(char* filename)
{
	ifstream fin;
	int fileSize;
	char input;
...
void ScreenTextureShader::OutputShaderErrorMessage(OpenGLClass* OpenGL, HWND hwnd, unsigned int shaderId, char* shaderFilename)
{
	int logSize, i;
	char* infoLog;
	ofstream fout;
...
void ScreenTextureShader::OutputLinkerErrorMessage(OpenGLClass* OpenGL, HWND hwnd, unsigned int programId)
{
	int logSize, i;
	char* infoLog;
	ofstream fout;
...
void ScreenTextureShader::ShutdownShader(OpenGLClass* OpenGL)
{
...
bool ScreenTextureShader::SetShaderParameters(OpenGLClass* OpenGL, float* worldMatrix, float* viewMatrix, float* projectionMatrix, int textureUnit)
{
